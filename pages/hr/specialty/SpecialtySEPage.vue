<template>
  <q-page class="q-pa-sm">
    <!-- FORM -->
    <div v-if="Specialty.loading" class="flex flex-center q-pa-lg">
...
async function load(id) {
  ...
  if (String(Specialty.row?.id) === String(id)) {
    Specialty.form = Specialty.row
    return
  }

  Specialty.row = await Specialty.getById(id)
}
