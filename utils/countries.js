// International calling codes (ISO 3166-1 alpha-2 + E.164 dial code)
// Lusophone countries listed first for convenience in this app's primary markets.
...
// (regional indicator symbols), avoiding hand-typed flag glyphs.
...
export function countryLabel (country) {
  if (!country) return ''
  return `${isoToFlag(country.iso2)} ${country.name} (+${country.dial})`
}
