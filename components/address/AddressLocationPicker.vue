...
<q-card-section class="q-pa-sm q-pa-sm-md"><div class="row q-col-gutter-md q-row-gutter-md"><div class="col-12">
<!-- ============================================= -->
<!-- SEARCH + GEOLOCATION -->
<!-- ============================================= -->
...
outlined
clearable
:label="mapsReady ? tdc('Search an address') : tdc('Formatted address')"
...
<!-- MAP / FALLBACK -->
<!-- ============================================= -->
<div class="col-12"><div class="map-shell">
<div
v-if="mapsReady"
ref="mapEl"
class="map-surface"
...
<!-- ============================================= -->
<div class="col-12"><div class="row q-col-gutter-md q-row-gutter-sm">
...
<!-- ============================================= -->
<div class="col-12"><q-expansion-item
dense
:label="tdc('Address details')"
icon="edit_location_alt"
header-class="text-caption text-weight-medium"
>
<div class="row q-col-gutter-md q-row-gutter-sm q-pt-md"><div class="col-12">
<s-input
v-model="form.formatted_address"
dense
outlined
:label="tdc('Formatted address')"
@update:model-value="emitUpdate"
/></div>
<div class="col-12"><div class="row q-col-gutter-md q-row-gutter-sm">
<div class="col-12 col-sm-6">
<s-input v-model="form.locality" dense outlined :label="tdc('City')" @update:model-value="emitUpdate" />
</div>
<div class="col-12 col-sm-6">
<s-input v-model="form.administrative_area_level_1" dense outlined :label="tdc('Province / State')" @update:model-value="emitUpdate" />
</div>
<div class="col-12 col-sm-6">
<s-input v-model="form.postal_code" dense outlined :label="tdc('Postal code')" @update:model-value="emitUpdate" />
</div>
<div class="col-12 col-sm-6">
<s-select
